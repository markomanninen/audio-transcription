...
describe('FileUploader', () => {
  ...
  it('displays accepted file formats', () => {
    ...
    expect(
      screen.getByText(/Supports: MP3, WAV, M4A, MP4, WebM, OGG, FLAC/i)
    ).toBeInTheDocument()
  })
  ...
  it('handles drag and drop events', () => {
    ...
    const label = screen.getByText(/Drop audio file here/i).closest('label')
    const dropZone = label?.parentElement as HTMLElement
